...
export const metadata: Metadata = {
  ...
  description: 'Open-source AI troubleshooting assistant that helps Developers, SREs, and DevOps engineers diagnose complex issues faster. Remembers your infrastructure and past incidents. Available as self-hosted or fully managed SaaS.',
  ...
  openGraph: {
    ...
    description: 'AI troubleshooting copilot that remembers your infrastructure and past incidents. Never solve the same problem twice. Self-hosted open source or fully managed SaaS.',
    siteName: 'FaultMaven',
  },
  twitter: {
