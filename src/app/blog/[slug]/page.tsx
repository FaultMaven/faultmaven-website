    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-900 py-12 md:py-16">
      <article className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-14 border border-slate-200/80 dark:border-slate-700/80 shadow-sm mb-16">
          <div
            className="prose dark:prose-invert max-w-none text-slate-800 dark:text-slate-200 leading-relaxed space-y-6 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-slate-900 [&_h2]:dark:text-slate-100 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:text-base [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_code]:bg-slate-100 [&_code]:dark:bg-slate-900 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono [&_pre]:bg-slate-900 [&_pre]:text-slate-100 [&_pre]:p-4 [&_pre]:rounded-xl [&_pre]:overflow-x-auto [&_blockquote]:border-l-4 [&_blockquote]:border-blue-500 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-slate-600 [&_blockquote]:dark:text-slate-400 [&_table]:w-full [&_table]:border-collapse [&_th]:border [&_th]:border-slate-300 [&_th]:dark:border-slate-700 [&_th]:p-3 [&_th]:bg-slate-100 [&_th]:dark:bg-slate-700 [&_td]:border [&_td]:border-slate-300 [&_td]:dark:border-slate-700 [&_td]:p-3"
