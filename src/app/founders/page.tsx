        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-700 dark:text-slate-300 mt-2">
                For larger teams evaluating FaultMaven, contact us directly: <a href="mailto:hello@faultmaven.com" className="text-blue-600 dark:text-blue-400 hover:underline">hello@faultmaven.com</a>
              </p>
            </div>
