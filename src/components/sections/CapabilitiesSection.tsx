    ...
    <section className="py-24 bg-white dark:bg-slate-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 mb-16 max-w-3xl mx-auto text-center">
          Start with a question, not necessarily a crisis. Upload a log or point FaultMaven at a dashboard and just ask whether anything looks off — it answers like a sharp teammate, and because it&apos;s tuned for problem detection, it flags what&apos;s out of the ordinary. When something real surfaces, it shifts from that inquiry into a full, evidence-grounded investigation.
        </p>
