    ...
    <Section>
      ...
      <div className="grid gap-8 md:grid-cols-3">
        ...
        <Card className="flex flex-col">
          ...
          <p className={`${eyebrowClass} mt-2 mb-4 normal-case tracking-normal`}>In your browser · nothing to install</p>
        ...
        <Card className="flex flex-col">
          ...
          <p className={`${eyebrowClass} mt-2 mb-4 normal-case tracking-normal`}>For the individual engineer · browser extension</p>
          <p className="mb-4 flex-grow text-slate-600 dark:text-slate-400">
        ...
        <Card className="flex flex-col">
          ...
          <p className={`${eyebrowClass} mt-2 mb-4 normal-case tracking-normal`}>For the team · in the channel</p>
          <p className="mb-4 flex-grow text-slate-600 dark:text-slate-400">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            ...
            <a href={COMMUNITY_SLACK_URL} target="_blank" rel="noopener noreferrer" className={linkClass}>
