    ...
    <section className="py-32 bg-white dark:bg-slate-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-center text-lg text-slate-600 dark:text-slate-400 mt-16 max-w-3xl mx-auto">
          FaultMaven bridges this gap—injecting deep context into AI reasoning so you get answers that actually work for <strong className="text-slate-700 dark:text-slate-300">YOUR</strong> infrastructure.
        </p>
      </div>
    </section>
  );
